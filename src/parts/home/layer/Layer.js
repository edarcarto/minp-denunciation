...
const Layer = (props) => {
    return (
        <div className="section white no-pad-top">
            <div className="section purple accent-1 no-pad-bot z-depth-1 start-splash-section">
                    ...
                    <div className="row">
                        <div className="col s12 l6 text-center">
                            <div className="white-text start-splash-header-content">
                                ...
                                <br/>
                                <a href="/" className="waves-effect waves-light btn-floating btn-large purple">
